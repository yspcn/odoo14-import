                                ...
                                if row[0] != running_tmpl:
                                    ...
                                    if row[6].strip() not in (None, ""):
                                        for x in row[6].split(','):
                                            x = x.strip()
                                            if x != '':
                                                search_public_categ = self.env['product.public.category'].search(
                                                    [('name', '=', x)], limit=1)
                                                if search_public_categ:
                                                    ...
                                                    skipped_line_no[str(
                                                        counter)] = " - eCommerce Category " + x + " not found. "
                                                    break
                                    ...
                                    if some_public_categ_not_found:
                                        ...
                                        tmpl_vals.update(
                                            {'public_categ_ids': [(6, 0, public_categ_ids_list)]})
                                    ...
                                    if row[12].strip() == 'Delivered quantities':
                                        tmpl_vals.update(
                                    ...
                                    if image_base64_list:
                                        ...
                                        tmpl_vals.update({
                                            "product_template_image_ids": multi_img_vals_list
                                        })
                                    ...
                                    if row[17].strip() in (None, "") or row[18].strip() in (None, ""):
...
#                                         created_product_tmpl.attribute_line_ids = False
                                    ...
                                    if has_variant == False and row[23] not in (None, ""):
                                ...
                                if created_product_tmpl and has_variant:
                                    ...
                                    if row[17].strip() not in (None, "") and row[18].strip() not in (None, ""):
                                        attr_ids_list = []
                                        ...
                                        if self.method == 'create':
                                            ...
                                            if created_product_tmpl.product_variant_ids:
                                                ...
                                                if product_varient.type == 'product' and row[23] != '':
                                                    stock_vals = {'product_tmpl_id': created_product_tmpl.id,
                                                                  'new_quantity': row[23],
                                                ...
                                                if image_base64_list:
                                                    ...
                                                    var_vals.update({
                                                        "product_variant_image_ids": multi_img_vals_list
                                                    })
